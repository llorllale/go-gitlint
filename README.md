...
![Build Status](https://github.com/llorllale/go-gitlint/actions/workflows/ci-cd.yaml/badge.svg)
...
## Build dependencies
To run `make checks` you will need Go `1.25.x` and Ruby `3.x` (for `pdd` - see  below).
